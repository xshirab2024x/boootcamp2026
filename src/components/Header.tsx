...
export const Header: React.FC = () => {
  return (
    ...
    >
      ...
      <div
        className="relative flex flex-col gap-6 items-start py-[140px]"
        style={{ minHeight: "518px", zIndex: 20 }}
      >
        {/* Logo */}
        <div className="w-[619px] h-[121px] relative">
          <img
            src={ASSETS.logo}
            alt="Bootcamp 2026"
        ...
        <div className="flex flex-col gap-6">
          <motion.div
            ...
            className="font-bold text-[40px] leading-[48px] text-white"
          >
            <p>La experiencia que potencia tu</p>
            <p>formación en los negocios digitales</p>
          </motion.div>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.1, duration: 0.6 }}
            className="text-[32px] font-normal text-white uppercase"
          >
            17 AL 18 DE ABRIL
          </motion.p>
        </div>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.97 }}
          className="w-[302px] h-[50px] bg-[#02abfc] border-2 border-[#006798] text-white rounded-[40px] font-bold text-[16px] tracking-[-0.304px]"
        >
